...
9. When changing existing UI truncation or width behavior, preserve the established text alignment unless the user explicitly requests a new alignment, and add a regression test for it.
