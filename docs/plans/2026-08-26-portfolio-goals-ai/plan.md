...
## Success Criteria
- [ ] AC1–AC16 demonstrated (tests + screenshots)
- [ ] Existing goal tests still green; legacy goals render unchanged
- [ ] Aggregate sent to the AI contains no asset names/tickers/units (test asserts)
- [ ] Verification output pasted in Progress Log
